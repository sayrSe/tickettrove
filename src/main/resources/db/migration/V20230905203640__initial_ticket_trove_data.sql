...
VALUES
  ('The Nun II', 'https://cdn1.clickthecity.com/images/movies/poster/400/19136_3.jpg', 'In 1956 France, a priest is murdered, and it seems an evil is spreading. Sister Irene once again comes face to face with a demonic force.', 'Sister Irene returns once again and comes face to face with the demonic force Valak.', '2023-09-08', 109, 'Rated R', 'Michael Chaves', 'Taissa Farmiga, Jonas Bloquet, Storm Reid'),
...
VALUES
    (1, 1, 1, '2023-09-08 17:00:00', '2023-09-08 19:00:00'),
    (1, 1, 2, '2023-09-08 19:00:00', '2023-09-08 21:00:00'),
    (1, 2, 3, '2023-09-08 18:00:00', '2023-09-08 20:00:00'),
    (1, 3, 5, '2023-09-08 17:00:00', '2023-09-08 18:00:00'),
    (1, 3, 5, '2023-09-09 17:00:00', '2023-09-09 18:30:00'),
    (1, 3, 5, '2023-09-09 18:00:00', '2023-09-09 20:30:00'),
    (1, 2, 3, '2023-09-10 19:00:00', '2023-09-10 21:30:00');
...
Update movie
set  short_description = 'Mission: Impossible is based on the TV series by Bruce Geller.',
...
Update movie
set
short_description ='She decides to go to the Real World '
where id = 6;
Update movie
set
short_description ='A nun pregnant with twins the target of a terrifying religious sect'
where id = 2;
Update movie
set
short_description ='Sister Irene returns to face  the demonic force Valak.'
where id = 1;
...
SET `short_description` =
  'Sister Irene returns once again and comes face to face with the demonic force Valak.'
WHERE `title` = 'The Nun II';

UPDATE `movie`
SET `short_description` =
  'Pregnant nun targeted by terrifying religious sect, aided by a young priest in a faith crisis.'
WHERE `title` = 'Deliver Us';

UPDATE `movie`
SET `short_description` =
  'Turtle brothers seek acceptance in NYC through heroic acts after sheltered life years.',
  title ='TMNT: Mutant Mayhem'
where id = 3;

UPDATE `movie`
SET `short_description` =
  'Berlin businessman Matt Turner races to complete tasks to defuse a bomb under his car seat.'
WHERE `title` = 'Retribution';

UPDATE `movie`
SET `short_description` =
  'The team faces chaos as a malevolent mining operation threatens their deep-sea mission.'
WHERE `title` = 'Meg 2 The Trench';

UPDATE `movie`
SET `short_description` =
  'Barbie societal impact explored, embarks on a quest to find a cure in the Real World.'
WHERE `title` = 'BARBIE';

UPDATE `movie`
SET `short_description` =
  'Kindergartener Shinnosuke gains telekinetic superpowers after a cosmic event on Earth.'
WHERE `title` = 'Crayon Shin-Chan';

UPDATE `movie`
SET `short_description` =
  'Reggie, abandoned in the city, believes his owner would never leave him on purpose.'
WHERE `title` = 'Strays';

UPDATE `movie`
SET `short_description` =
  'Hercule Poirot attends a Halloween séance in a haunted palazzo, reluctantly, in Venice.'
WHERE `title` = 'A Haunting in Venice';

UPDATE `movie`
SET `short_description` =
  'Robert McCall discovers his friends are under the control of local crime bosses in Italy.'
WHERE `title` = 'Equalizer 3';

UPDATE `movie`
SET `short_description` =
  'IU CONCERT: The Golden Hour celebrates the 15th anniversary of IU debut in a Cinematic Cut.'
WHERE `title` = 'IU Concert: The Golden Hour';